...
<form id="CatalogForm" action="blog/addtype" method="post">
    <h3> 添加博客分类 </h3>
    <div id="error_msg" class="error_msg" style="display:none;"></div>
    <label>分类名称:</label><input id="txt_link_name" name="typename" size="15" tabindex="1" type="text">
...
<table cellpadding="1" cellspacing="1">
	...
	foreach($types as $type){
		...
		echo "<td class='name'><a href='' title='点击修改博客分类'>".$type->type_name."</a></td>";
