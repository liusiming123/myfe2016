...
<form id="frm_reg" action="user/regist" method="POST" style="float:left; width:620px;">
	...
	<table cellpadding="0" cellspacing="0">
    	...
    	<tr>
    		<th>登录密码：</th>
    		<td><input name="password" id="f_pwd" class="TEXT" style="width: 150px;" type="password">
				<span id="password_msg">至少四位</span>		
			</td>    		
    	</tr>
    	<tr>
    		<th>密码确认：</th>		
    		<td><input name="password2" id="f_pwd2" class="TEXT" style="width: 150px;" type="password"></td>
    	</tr>
    	<tr id="tr_gender">
        	<th>性别：</th>		
    		<td>
				<input name="sex" value="男" id="gender_1" type="radio"><label for="gender_1">男</label>&nbsp;&nbsp;&nbsp;
